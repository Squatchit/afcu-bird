...
var BackgroundLayer = me.ImageLayer.extend({
    ...
    Share = me.GUI_Object.extend({
        init: function(a, b) {
            var c = {};
            c.image = "share", c.framewidth = 0, c.frameheight = 0, this._super(me.GUI_Object, "init", [a, b, c])
        },
        onClick: function(a) {
    ...
    Tweet = me.GUI_Object.extend({
        init: function(a, b) {
            var c = {};
            c.image = "tweet", c.framewidth = 0, c.frameheight = 0, this._super(me.GUI_Object, "init", [a, b, c])
        },
        onClick: function(a) {
            var b = "Just made " + game.data.steps + " steps on Clumsy Bird! Can you beat me? Try online here!",
                c = "http://ellisonleao.github.io/clumsy-bird/",
...
game.TitleScreen = me.ScreenObject.extend({
    ...
    onResetEvent: function() {
        ...
        this.dialog = new(me.Renderable.extend({
            init: function() {
                this._super(me.Renderable, "init", [0, 0, 100, 100]), this.font = new me.Font("gamefont", 40, "black", "left"), this.steps = "Score: " + game.data.steps.toString(), this.topSteps = "High Score: " + me.save.topSteps.toString()
            },
            draw: function(a) {
